...
class GamesRepositoryImpl @Inject constructor(
    ...
    private val local: RawgLocalDataSourceImpl
        ...
        override suspend fun fetchGameList(): Flow<DataResource<List<GameItemEntities>>> {
        return object : NetworkBoundResource<List<GameItemEntities>, GetGameListDto>() {
            override suspend fun loadFromDB(): Flow<List<GameItemEntities>> = local.loadGameList()

            override suspend fun shouldFetch(data: List<GameItemEntities>?): Boolean = true
